...
В данном коде выводятся одна строки с использованием функции `print()` и функции `len()`.
...
В данном коде выводятся одна строки с использованием функции `print()` так же используется метод `lower()` .
...
В данном коде выводятся одна строки с использованием функции `print()` так же используется функция `abs()` .
